# /d — Agentic 7-Step Workflow

> [!IMPORTANT]
> **DO NOT SKIP STEPS** unless user explicitly says "do it quickly" or "fast".

**The user's actual task/question follows this command.** Execute that task NOW while strictly following the workflow below. `/d` enforces the rules; the user's message is the work to be done.
...
**Full reference**: See `AGENTS.md` in the repository root for complete agentic SOPs.
