...
export default function BareCalculatorPage() {
    ...
    const insulationMaterialRestriction = CONSTANTS.INSULATION_TYPES.find((t) => t.name === insulation)?.materialRestriction;
    useEffect(() => {
        if (insulation !== "Bare" && insulationMaterialRestriction && insulationMaterialRestriction !== material) {
            setInsulation("Bare");
        }
    }, [material, insulation, insulationMaterialRestriction]);
