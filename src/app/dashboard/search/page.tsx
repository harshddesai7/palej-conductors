                        ...
                        <table className="w-full text-left border-collapse min-w-max">
                            <thead className="sticky top-0 z-20 bg-slate-50/95 backdrop-blur-sm">
                                <tr className="bg-slate-50/95 text-[9px] font-bold uppercase tracking-widest text-slate-500">
                                    {/* Unified Calculator Headers */}
                                    {selectedDatabase === "unified" && (
                                        <>
                                            <th 
                                                className="sticky left-0 z-30 bg-slate-50/95 px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                            ...
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                            ...
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                                onClick={() => handleSort("insulationType")}
                                            >
                                                <div className="flex items-center gap-1">
                                                    <span>Insulation</span>
                                                    {getSortIcon("insulationType")}
                                                </div>
                                            </th>
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                                onClick={() => handleSort("kV")}
                                            >
                                                <div className="flex items-center gap-1">
                                                    <span>kV</span>
                                                    {getSortIcon("kV")}
                                            ...
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                                onClick={() => handleSort("percentIncrease")}
                                            >
                                                <div className="flex items-center gap-1">
                                                    <span>% Inc</span>
                                                    {getSortIcon("percentIncrease")}
                                                </div>
                                            </th>
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                                onClick={() => handleSort("bareWtReqd")}
                                            >
                                                <div className="flex items-center gap-1">
                                                    <span>Bare Wt</span>
                                                    {getSortIcon("bareWtReqd")}
                                                </div>
                                            </th>
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                            ...
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                                onClick={() => handleSort("metersPerSpool")}
                                            >
                                                <div className="flex items-center gap-1">
                                                    <span>M/Spool</span>
                                                    {getSortIcon("metersPerSpool")}
                                                </div>
                                            </th>
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                    ...
                                    {selectedDatabase === "factor" && (
                                        <>
                                            ...
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                                onClick={() => handleSort("covering")}
                                            >
                                                <div className="flex items-center gap-1">
                                                    <span>Covering</span>
                                                    {getSortIcon("covering")}
                                                </div>
                                            </th>
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                            ...
                                            >
                                                <div className="flex items-center gap-1">
                                                    <span>% Inc</span>
                                                    {getSortIcon("percentageIncrease")}
                                                </div>
                                            </th>
                                            <th 
                                                className="px-3 py-2 border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors"
                                    ...
                                    <tr key={item._id} className="hover:bg-slate-50/30 transition-colors">
                                        ...
                                        {selectedDatabase === "unified" && (
                                            <>
                                                ...
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.material || "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.shape || "—"}
                                                ...
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {formatInsulationThickness(item)}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.inputs?.factor ? item.inputs.factor.toFixed(4) : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.results?.percentIncrease ? `${item.results.percentIncrease.toFixed(2)}%` : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.results?.bareWtReqd ? `${item.results.bareWtReqd.toFixed(2)} kg` : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.inputs?.finalWtReqd ? `${item.inputs.finalWtReqd.toFixed(2)} kg` : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.results?.metersPerSpool ? `${item.results.metersPerSpool.toFixed(0)} m` : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.results?.productionKgHr ? `${item.results.productionKgHr.toFixed(2)} kg/hr` : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.results?.totalHoursReqd ? `${item.results.totalHoursReqd.toFixed(2)} hrs` : "—"}
                                                </td>
                                        ...
                                        {selectedDatabase === "factor" && (
                                            <>
                                                ...
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.inputs?.width && item.inputs?.thickness 
                                                        ? `${item.inputs.width}×${item.inputs.thickness}`
                                                        : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.inputs?.covering ? `${item.inputs.covering.toFixed(2)} mm` : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap">
                                                    {item.inputs?.percentageIncrease ? `${item.inputs.percentageIncrease.toFixed(2)}%` : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100 text-xs text-slate-600 whitespace-nowrap font-medium">
                                                    {item.results?.factor ? item.results.factor.toFixed(6) : "—"}
                                                </td>
                                                <td className="px-3 py-2 border-b border-slate-100">
                                                    <span className={cn(
                                                        "text-[9px] font-bold px-1.5 py-0.5 rounded-full whitespace-nowrap",
