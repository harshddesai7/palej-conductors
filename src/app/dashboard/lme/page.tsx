    ...
    return (
        <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">LME Copper Pricing</h1>
                    <p className="text-slate-500 mt-1 text-sm sm:text-base">International metal index rates & localized pricing</p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={isSaving}
                ...
                >
                    {isSaving ? "Saving..." : <><Save className="w-4 h-4" /> Save Pricing</>}
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                <div className="glass p-8 rounded-3xl space-y-8 h-fit">
                    <div className="space-y-6">
                        <InputGroup
                            ...
                            type="date"
                            value={rateDate}
                            onChange={(e: any) => setRateDate(e.target.value)}
                        />
                ...
                <div className="space-y-6">
                    <div className="glass p-6 sm:p-8 rounded-3xl space-y-8 h-full">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="p-6 bg-indigo-600 rounded-3xl text-white shadow-xl shadow-indigo-100 space-y-2">
                                    ...
                                    <div className="text-2xl sm:text-3xl font-black">₹{results.cspRate.toFixed(2)}</div>
                                ...
                                <div className="p-6 bg-slate-900 rounded-3xl text-white shadow-xl shadow-slate-100 space-y-2">
                                    ...
                                    <div className="text-2xl sm:text-3xl font-black">₹{results.wwmaiRate.toFixed(2)}</div>
...
function InputGroup({ label, value, onChange, placeholder, icon, type = "number" }: any) {
    return (
        <div className="space-y-2">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className={cn(
                        "w-full bg-white/40 border border-slate-200 rounded-2xl pr-6 py-4 text-slate-900 focus:ring-2 focus:ring-slate-900 focus:border-transparent outline-none transition-all font-bold text-xl",
                        icon ? "pl-12" : "pl-6"
                    )}
                />
            </div>
