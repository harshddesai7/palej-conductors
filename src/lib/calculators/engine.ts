...
export const CONSTANTS = {
  ...
  INSULATION_TYPES: [
    ...
    { name: "Poly + Paper (Alu)", factorAlu: 0.95, materialRestriction: "ALUMINIUM", defaultThicknessStrip: 0.50, defaultThicknessWire: 0.40 },
    { name: "Poly + Paper (Cu)", factorCu: 0.95, materialRestriction: "COPPER", defaultThicknessStrip: 0.50, defaultThicknessWire: 0.40 },
