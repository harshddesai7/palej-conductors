...
- [src/app/dashboard/search/page.tsx](src/app/dashboard/search/page.tsx): Search Database route; dynamically imports SearchDatabaseClient with ssr:false.
- [src/app/dashboard/search/SearchDatabaseClient.tsx](src/app/dashboard/search/SearchDatabaseClient.tsx): Search Database UI with Convex useQuery, table, sort, filter.
- [src/app/dashboard/search/error.tsx](src/app/dashboard/search/error.tsx): Error boundary for Search Database route; shows friendly fallback on client-side exception.
